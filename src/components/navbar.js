		...
		<div className="nav">
			...
			<div className="nav-right">
				<ul className="nav-item">
					...
					<li><Link style={{textDecoration: 'none', color: "#FFFFFF"}} to={"/#about"} smooth activeStyle={{ textDecoration: "underline"}}>About Us</Link></li>
					<li><Link style={{textDecoration: 'none', color: "#FFFFFF"}} to={"/#main"}>Cities</Link></li>
				</ul>
				<button className="call-button-light">Call</button>
				<button className="hamburger"><svg width="40" height="36" viewBox="0 0 40 36" fill="none" xmlns="http://www.w3.org/2000/svg">
